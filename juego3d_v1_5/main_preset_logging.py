    ...
    *,
    ...
    try:
        ...
        line = (
            ...
            f"rescue={render_stats.get('frame_rescue_label', 'OK')} "
            f"rescueLevel={render_stats.get('frame_rescue_level', 0)} "
            ...
            f"farTiles={render_stats.get('far_terrain_tiles_visible', 0)} "
            f"farBuilt={render_stats.get('far_terrain_tiles_built', 0)} "
            f"farCache={render_stats.get('far_terrain_tiles_cached', 0)} "
            f"farTile={render_stats.get('far_terrain_tile_size', 0)} "
            f"farSub={render_stats.get('far_terrain_subdivisions', 0)} "
            f"farMax={render_stats.get('far_terrain_max_visible', 0)} "
            f"farRadius={render_stats.get('far_terrain_radius', 0)} "
            f"farScale={float(render_stats.get('far_terrain_height_scale', 0.0) or 0.0):.2f} "
            f"skyHint={render_stats.get('sky_biome_hint', 'none')} "
            f"skyWorldTint={float(render_stats.get('sky_world_tint_alpha', 0.0) or 0.0):.2f} "

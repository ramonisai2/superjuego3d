...
MATERIALS: Dict[str, MaterialInfo] = {
    ...
    "water": MaterialInfo("water", sort_order=900, blend=True, depth_write=False, double_sided=True, alpha=0.20, debug_color=(0.22, 0.55, 0.75, 0.20), notes="Agua translucida"),

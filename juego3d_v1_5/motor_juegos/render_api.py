...
class RendererBackendAPI(Protocol):
    ...
    def is_chunk_visible(self, env_module: Any, cx: int, cz: int, px: float, pz: float, lx: float, lz: float, *, size: float, max_distance: float, near_keep: Optional[float] = None, back_margin: Optional[float] = None) -> bool: ...
